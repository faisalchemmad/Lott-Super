              ...
              child: Column(
                ...
                children: [
                      ...
                      items: [
                        ...
                        ..._agents
                            .where((a) =>
                                ...
                                (a.role != 'SUB_DEALER' && a.role != 'DEALER' ||
                                    a.parent == _currentUser?.id))
                  ...
                  Row(
                    ...
                    children: [
                      _buildToggle('FULL VIEW', _fullView,
                          (v) => setState(() => _fullView = v)),
                      if (_userRole != 'SUB_DEALER')
